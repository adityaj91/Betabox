...
.controller('homeCtrl', function($scope, $ionicPopup, $state, Prototypes) {
  $scope.monthlyStock = Prototypes.getMonthStock();
...
.controller('archiveCtrl', function($scope, $ionicPopup, $state, Prototypes) {
  $scope.prototype = Prototypes.all();
...
.controller('productDetailCtrl', function($scope, $ionicPopup, $state, Prototypes, $stateParams, $cordovaSocialSharing, $cordovaInstagram) {
