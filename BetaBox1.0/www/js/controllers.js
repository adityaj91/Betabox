...
.controller('loginCtrl', function($scope, LoginService, $ionicPopup,$state, Prototypes) {
  ...
  $scope.login = function() {
    ...
    Prototypes.updateViewList('tabs.home', "None", true, "All", "All", "Last Month", "All");
    $state.go('tabs.home');
    }).error(function(data) {
...
.controller('homeCtrl', function($scope, $ionicPopup, $state, Prototypes) {
  $scope.monthlyStock = Prototypes.getViewList('tabs.home');
...
.controller('productDetailCtrl', function($scope, $ionicPopup, $state, Prototypes, $stateParams, $cordovaSocialSharing, $cordovaInstagram, $ionicHistory) {
  ...
  $scope.goToProduct = function(productName) {
    $state.go('companyDetail', {id: productName});
  }
...
.controller('companyDetailCtrl', function($scope, $ionicPopup, $state, Prototypes, $stateParams, $cordovaSocialSharing, $cordovaInstagram) {
  $scope.prototype = Prototypes.get($stateParams.id);
...
.controller('tabsCtrl', function($scope, $state, $ionicSideMenuDelegate, Prototypes, $ionicHistory) {
  ...
  $scope.applyOptions = function () {
    Prototypes.updateViewList(currentState, $scope.sort.selected, $scope.ascendingSort, $scope.filter.selectedCompany, $scope.filter.selectedRate, $scope.filter.selectedDuration, $scope.filter.selectedCategory);
    $scope.toggleMenu();
  }
});
